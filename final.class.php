...
class final_rest
{
	/**
         ...
         * @apiName getWeather
         * @apiDescription get weather from date
         *
         * @apiParam {dateField} date
         *
...

	{
		try {
			...
			$retData["message"]="lookup of date '$date' accepted";
	 ...
	 * @apiName setWeather
	 * @apiDescription Add weather
	 *
	 * @apiParam {string} location
	 * @apiParam {String} MapJson
	 * @apiParam {double} WeatherJson
	 *
	 * @apiSuccess {Integer} status
	 * @apiSuccess {string} message
	 *
...

	{
		try {
			...
			$retData["status"]=0;
			$retData["message"]="insert of '$value' for location: '$MapJson' and sensor '$WeatherJson' accepted";
		}
		catch  (Exception $e) {
			$retData["status"]=1;
			$retData["message"]=$e->getMessage();
